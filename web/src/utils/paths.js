...
export const PossibleBlocksPath = '/safras/:year/previa-bloqueio';
export const blockedPath = '/safras/:year/bloqueios';
export const canceledPath = '/safras/:year/cancelamentos';
