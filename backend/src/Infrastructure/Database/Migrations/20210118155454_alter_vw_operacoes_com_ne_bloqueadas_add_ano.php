...
class AlterVwOperacoesComNeBloqueadasAddAno extends AbstractMigration
{
    public function up(): void
    {
        $query = <<<SQL
            ALTER VIEW [dbo].[vw_operacoes_com_ne_bloqueadas] AS
            SELECT DISTINCT
                a.id,
                h.anoExecucao,
                h.anoOrcamentario,
    ...
    {
        $query = <<<SQL
            ALTER VIEW vw_operacoes_com_ne_bloqueadas AS
            SELECT DISTINCT
                a.id,
                h.anoExecucao,
                h.anoOrcamentario,
