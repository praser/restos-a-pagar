...
class AlterVwSaldosNotasEmpenhoAddAno extends AbstractMigration
{
    public function up(): void
    {
        $query = <<<SQL
            ...
            JOIN (
                ...
                JOIN(
                    SELECT YEAR(dataReferencia) AS ano, MAX(dataReferencia) AS dataReferencia FROM saldos_notas_empenhos GROUP BY YEAR(dataReferencia)
                ) b
