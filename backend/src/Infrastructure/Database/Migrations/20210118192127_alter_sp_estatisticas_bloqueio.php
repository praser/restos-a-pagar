...
class AlterSpEstatisticasBloqueio extends AbstractMigration
{
    public function up(): void
    {
        $query = <<<SQL
            ...
            SELECT 
                ...
                SUM(quantidadeDocumentos) OVER (ORDER BY dataDesbloqueio ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) AS quantidadeDocumentos,
