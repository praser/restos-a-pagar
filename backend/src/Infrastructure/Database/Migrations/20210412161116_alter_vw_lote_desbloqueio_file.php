...
class AlterVwLoteDesbloqueioFile extends AbstractMigration
{
    public function up(): void
    {
        $query = <<<SQL
            ALTER VIEW vw_lote_desbloqueio_file AS
            SELECT
                ...
                ,h.convenio
                ,b.documento
                ,REPLACE(b.saldo, '.', ',') AS valorBloqueado
                ,REPLACE(h.percentualFisicoAferido, '.', ',') AS percentualFisicoAferido
                ,CASE
