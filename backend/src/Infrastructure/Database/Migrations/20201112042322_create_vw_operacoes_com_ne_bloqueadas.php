...
class CreateVwOperacoesComNeBloqueadas extends AbstractMigration
{
    public function up(): void
    {
        $query = <<<SQL
            CREATE VIEW [dbo].[vw_operacoes_com_ne_bloqueadas] AS
            SELECT DISTINCT
                a.id,
                h.anoExecucao,
                h.anoOrcamentario,
    ...
    {
        $this->execute('DROP VIEW [dbo].[vw_operacoes_com_ne_bloqueadas]');       
    }
}
