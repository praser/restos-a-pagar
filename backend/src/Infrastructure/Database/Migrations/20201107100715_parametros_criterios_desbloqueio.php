...
class ParametrosCriteriosDesbloqueio extends AbstractMigration
{
    public function change()
    {
        $this
            ...
            ->addColumn('responsavelUnidadeId', 'string', ['comment' => 'Código da unidade de lotação física no responsável pelo cadastramento do critério na data do cadastramento'])
