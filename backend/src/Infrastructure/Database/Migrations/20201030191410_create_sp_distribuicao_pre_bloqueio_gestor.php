...
class CreateSpDistribuicaoPreBloqueioGestor extends AbstractMigration
{
    public function up()
    {
        $query = <<<SQL
                CREATE PROCEDURE [dbo].[SP_DISTRIBUICAO_PRE_BLOQUEIO_GESTOR]
                @anoExecucao AS INT,
    ...
    {
        $this->execute('DROP PROCEDURE SP_DISTRIBUICAO_PRE_BLOQUEIO_GESTOR');
    }
}
